    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/" element={<Home />}>
          ...
          <Route path="/admin" element={<RolesProtection role={"maticar_administrator"} />}>
            <Route path="panel" element={<AdminPanel />}></Route>
          </Route>
          <Route path="/worker" element={<RolesProtection role={"maticar_worker"} />}>
            <Route path="panel" element={<WorkerPanel />}></Route>
          </Route>
          <Route path="/user" element={<RolesProtection role={"maticar_user"} />}>
